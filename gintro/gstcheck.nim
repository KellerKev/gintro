...
proc pull*(self: Harness): gst.Buffer =
  let impl0 = gst_harness_pull(self)
  if impl0.isNil:
    return nil
  fnew(result, gBoxedFreeGstBuffer)
  result.impl = impl0
...
proc pullEvent*(self: Harness): gst.Event =
  let impl0 = gst_harness_pull_event(self)
  if impl0.isNil:
    return nil
...
proc pullUntilEos*(self: Harness; buf: var gst.Buffer): bool =
  ...
  result = toBool(gst_harness_pull_until_eos(self, cast[var ptr gst.Buffer00](addr buf.impl)))
  if buf != nil and buf.impl == nil:
    buf.ignoreFinalizer = true
    buf = nil
...
proc pullUpstreamEvent*(self: Harness): gst.Event =
  let impl0 = gst_harness_pull_upstream_event(self)
  if impl0.isNil:
    return nil
  fnew(result, gBoxedFreeGstEvent)
  result.impl = impl0
...
proc pushAndPull*(self: Harness; buffer: gst.Buffer): gst.Buffer =
  let impl0 = gst_harness_push_and_pull(self, cast[ptr gst.Buffer00](g_boxed_copy(gst_buffer_get_type(), buffer.impl)))
  if impl0.isNil:
    return nil
  fnew(result, gBoxedFreeGstBuffer)
  result.impl = impl0
...
proc pushEvent*(self: Harness; event: gst.Event): bool =
  toBool(gst_harness_push_event(self, cast[ptr gst.Event00](g_boxed_copy(gst_event_get_type(), event.impl))))
...
proc pushUpstreamEvent*(self: Harness; event: gst.Event): bool =
  toBool(gst_harness_push_upstream_event(self, cast[ptr gst.Event00](g_boxed_copy(gst_event_get_type(), event.impl))))
...
proc gst_harness_set_live(self: Harness; isLive: gboolean) {.
    importc, libprag.}

proc setLive*(self: Harness; isLive: bool = true) =
  gst_harness_set_live(self, gboolean(isLive))

proc `live=`*(self: Harness; isLive: bool) =
  gst_harness_set_live(self, gboolean(isLive))
...
proc tryPull*(self: Harness): gst.Buffer =
  let impl0 = gst_harness_try_pull(self)
  if impl0.isNil:
    return nil
  fnew(result, gBoxedFreeGstBuffer)
  result.impl = impl0
...
proc tryPullEvent*(self: Harness): gst.Event =
  let impl0 = gst_harness_try_pull_event(self)
  if impl0.isNil:
    return nil
  fnew(result, gBoxedFreeGstEvent)
  result.impl = impl0
...
proc tryPullUpstreamEvent*(self: Harness): gst.Event =
  let impl0 = gst_harness_try_pull_upstream_event(self)
  if impl0.isNil:
    return nil
  fnew(result, gBoxedFreeGstEvent)
  result.impl = impl0
