...
proc newMIKEYMessageFromCaps*(caps: gst.Caps): MIKEYMessage =
  let impl0 = gst_mikey_message_new_from_caps(cast[ptr gst.Caps00](caps.impl))
  if impl0.isNil:
    return nil
  fnew(result, gBoxedFreeGstMIKEYMessage)
  result.impl = impl0
...
proc getCsSrtp*(self: MIKEYMessage; idx: int): MIKEYMapSRTP =
  let impl0 = gst_mikey_message_get_cs_srtp(cast[ptr MIKEYMessage00](self.impl), uint32(idx))
  if impl0.isNil:
    return nil
  new(result)
  result.impl = impl0
...
proc kemacGetSub*(self: MIKEYPayload; idx: int): MIKEYPayload =
  let impl0 = gst_mikey_payload_kemac_get_sub(cast[ptr MIKEYPayload00](self.impl), uint32(idx))
  if impl0.isNil:
    return nil
  fnew(result, gBoxedFreeGstMIKEYPayload)
  result.impl = cast[typeof(result.impl)](g_boxed_copy(gst_mikey_payload_get_type(), impl0))
...
proc findPayload*(self: MIKEYMessage; `type`: MIKEYPayloadType;
  ...
  let impl0 = gst_mikey_message_find_payload(cast[ptr MIKEYMessage00](self.impl), `type`, uint32(nth))
  if impl0.isNil:
    return nil
  fnew(result, gBoxedFreeGstMIKEYPayload)
  result.impl = cast[typeof(result.impl)](g_boxed_copy(gst_mikey_payload_get_type(), impl0))
...
proc getPayload*(self: MIKEYMessage; idx: int): MIKEYPayload =
  let impl0 = gst_mikey_message_get_payload(cast[ptr MIKEYMessage00](self.impl), uint32(idx))
  if impl0.isNil:
    return nil
  fnew(result, gBoxedFreeGstMIKEYPayload)
  result.impl = cast[typeof(result.impl)](g_boxed_copy(gst_mikey_payload_get_type(), impl0))
...
proc spGetParam*(self: MIKEYPayload; idx: int): MIKEYPayloadSPParam =
  let impl0 = gst_mikey_payload_sp_get_param(cast[ptr MIKEYPayload00](self.impl), uint32(idx))
  if impl0.isNil:
    return nil
  new(result)
  result.impl = impl0
...
proc getAttributeVal*(self: SDPMedia; key: cstring): string =
  let resul0 = gst_sdp_media_get_attribute_val(cast[ptr SDPMedia00](self.impl), key)
  if resul0.isNil:
    return
  result = $resul0
...
proc getAttributeValN*(self: SDPMedia; key: cstring; nth: int): string =
  let resul0 = gst_sdp_media_get_attribute_val_n(cast[ptr SDPMedia00](self.impl), key, uint32(nth))
  if resul0.isNil:
    return
  result = $resul0
...
proc getCapsFromMedia*(self: SDPMedia; pt: int): gst.Caps =
  let impl0 = gst_sdp_media_get_caps_from_media(cast[ptr SDPMedia00](self.impl), int32(pt))
  if impl0.isNil:
    return nil
...
proc gst_sdp_media_init(media: var SDPMedia00): SDPResult {.
    importc, libprag.}

proc init*(media: var SDPMedia00): SDPResult =
...
proc gst_sdp_media_set_media_from_caps(caps: ptr gst.Caps00; media: var SDPMedia00): SDPResult {.
    importc, libprag.}

proc setMediaFromCaps*(caps: gst.Caps; media: var SDPMedia00): SDPResult =
  gst_sdp_media_set_media_from_caps(cast[ptr gst.Caps00](caps.impl), media)
...
proc getAttributeVal*(self: SDPMessage; key: cstring): string =
  let resul0 = gst_sdp_message_get_attribute_val(cast[ptr SDPMessage00](self.impl), key)
  if resul0.isNil:
    return
  result = $resul0
...
proc getAttributeValN*(self: SDPMessage; key: cstring;
    nth: int): string =
  let resul0 = gst_sdp_message_get_attribute_val_n(cast[ptr SDPMessage00](self.impl), key, uint32(nth))
  if resul0.isNil:
    return
  result = $resul0
...
proc gst_sdp_message_remove_media(self: ptr SDPMessage00; idx: uint32): SDPResult {.
    importc, libprag.}

proc removeMedia*(self: SDPMessage; idx: int): SDPResult =
  gst_sdp_message_remove_media(cast[ptr SDPMessage00](self.impl), uint32(idx))
...
proc gst_sdp_message_init(msg: var SDPMessage00): SDPResult {.
    importc, libprag.}

proc init*(msg: var SDPMessage00): SDPResult =
