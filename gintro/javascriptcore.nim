...
proc jsc_value_array_buffer_get_data(self: ptr Value00; size: var uint64): ptr uint8 {.
    importc, libprag.}

proc arrayBufferGetData*(self: Value; size: var uint64 = cast[var uint64](nil)): seq[uint8] =
  result = uint8ArrayToSeq(jsc_value_array_buffer_get_data(cast[ptr Value00](self.impl), size), size.int)
