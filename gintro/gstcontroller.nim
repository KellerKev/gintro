...
proc gst_argb_control_binding_new(obj: ptr gst.Object00; propertyName: cstring;
...
proc newARGBControlBinding*(obj: gst.Object; propertyName: cstring;
    csA: gst.ControlSource; csR: gst.ControlSource; csG: gst.ControlSource;
    csB: gst.ControlSource): ARGBControlBinding =
  let gobj = gst_argb_control_binding_new(cast[ptr gst.Object00](obj.impl), propertyName, cast[ptr gst.ControlSource00](csA.impl), cast[ptr gst.ControlSource00](csR.impl), cast[ptr gst.ControlSource00](csG.impl), cast[ptr gst.ControlSource00](csB.impl))
...
proc newARGBControlBinding*(tdesc: typedesc; obj: gst.Object; propertyName: cstring;
    csA: gst.ControlSource; csR: gst.ControlSource; csG: gst.ControlSource;
...
proc initARGBControlBinding*[T](result: var T; obj: gst.Object; propertyName: cstring;
    csA: gst.ControlSource; csR: gst.ControlSource; csG: gst.ControlSource;
...
proc gst_direct_control_binding_new(obj: ptr gst.Object00; propertyName: cstring;
    cs: ptr gst.ControlSource00): ptr DirectControlBinding00 {.
    importc, libprag.}

proc newDirectControlBinding*(obj: gst.Object; propertyName: cstring;
    cs: gst.ControlSource): DirectControlBinding =
  let gobj = gst_direct_control_binding_new(cast[ptr gst.Object00](obj.impl), propertyName, cast[ptr gst.ControlSource00](cs.impl))
  let qdata = g_object_get_qdata(gobj, Quark)
  if qdata != nil:
    result = cast[type(result)](qdata)
    assert(result.impl == gobj)
...
proc newDirectControlBinding*(tdesc: typedesc; obj: gst.Object; propertyName: cstring;
...
proc initDirectControlBinding*[T](result: var T; obj: gst.Object; propertyName: cstring;
...
proc gst_direct_control_binding_new_absolute(obj: ptr gst.Object00; propertyName: cstring;
    cs: ptr gst.ControlSource00): ptr DirectControlBinding00 {.
    importc, libprag.}

proc newDirectControlBindingAbsolute*(obj: gst.Object; propertyName: cstring;
    cs: gst.ControlSource): DirectControlBinding =
  let gobj = gst_direct_control_binding_new_absolute(cast[ptr gst.Object00](obj.impl), propertyName, cast[ptr gst.ControlSource00](cs.impl))
  let qdata = g_object_get_qdata(gobj, Quark)
  if qdata != nil:
    result = cast[type(result)](qdata)
    assert(result.impl == gobj)
...
proc newDirectControlBindingAbsolute*(tdesc: typedesc; obj: gst.Object; propertyName: cstring;
    cs: gst.ControlSource): tdesc =
  assert(result is DirectControlBinding)
  let gobj = gst_direct_control_binding_new_absolute(cast[ptr gst.Object00](obj.impl), propertyName, cast[ptr gst.ControlSource00](cs.impl))
  let qdata = g_object_get_qdata(gobj, Quark)
...
proc initDirectControlBindingAbsolute*[T](result: var T; obj: gst.Object; propertyName: cstring;
    cs: gst.ControlSource) {.deprecated.} =
  assert(result is DirectControlBinding)
  let gobj = gst_direct_control_binding_new_absolute(cast[ptr gst.Object00](obj.impl), propertyName, cast[ptr gst.ControlSource00](cs.impl))
  let qdata = g_object_get_qdata(gobj, Quark)
...
proc gst_proxy_control_binding_new(obj: ptr gst.Object00; propertyName: cstring;
    refObject: ptr gst.Object00; refPropertyName: cstring): ptr ProxyControlBinding00 {.
    importc, libprag.}

proc newProxyControlBinding*(obj: gst.Object; propertyName: cstring;
    refObject: gst.Object; refPropertyName: cstring): ProxyControlBinding =
  let gobj = gst_proxy_control_binding_new(cast[ptr gst.Object00](obj.impl), propertyName, cast[ptr gst.Object00](refObject.impl), refPropertyName)
  let qdata = g_object_get_qdata(gobj, Quark)
  if qdata != nil:
    result = cast[type(result)](qdata)
    assert(result.impl == gobj)
...
proc newProxyControlBinding*(tdesc: typedesc; obj: gst.Object; propertyName: cstring;
...
proc initProxyControlBinding*[T](result: var T; obj: gst.Object; propertyName: cstring;
