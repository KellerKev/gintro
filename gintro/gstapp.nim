...
type
  AppLeakyType* {.size: sizeof(cint), pure.} = enum
    none = 0
    upstream = 1
    downstream = 2
...
proc scNewSerializedEvent*(self: AppSink;  p: proc (self: ptr AppSink00; xdata: pointer): gboolean {.cdecl.}, xdata: pointer, cf: gobject.ConnectFlags): culong =
  g_signal_connect_data(self.impl, "new-serialized-event", cast[GCallback](p), xdata, nil, cf)

proc scProposeAllocation*(self: AppSink;  p: proc (self: ptr AppSink00; query: ptr gst.Query00; xdata: pointer): gboolean {.cdecl.}, xdata: pointer, cf: gobject.ConnectFlags): culong =
  g_signal_connect_data(self.impl, "propose-allocation", cast[GCallback](p), xdata, nil, cf)

proc scPullPreroll*(self: AppSink;  p: proc (self: ptr AppSink00; xdata: pointer): ptr gst.Sample00 {.cdecl.}, xdata: pointer, cf: gobject.ConnectFlags): culong =
  g_signal_connect_data(self.impl, "pull-preroll", cast[GCallback](p), xdata, nil, cf)

proc scPullSample*(self: AppSink;  p: proc (self: ptr AppSink00; xdata: pointer): ptr gst.Sample00 {.cdecl.}, xdata: pointer, cf: gobject.ConnectFlags): culong =
  g_signal_connect_data(self.impl, "pull-sample", cast[GCallback](p), xdata, nil, cf)

proc scTryPullObject*(self: AppSink;  p: proc (self: ptr AppSink00; timeout: uint64; xdata: pointer): ptr gst.MiniObject00 {.cdecl.}, xdata: pointer, cf: gobject.ConnectFlags): culong =
  g_signal_connect_data(self.impl, "try-pull-object", cast[GCallback](p), xdata, nil, cf)

proc scTryPullPreroll*(self: AppSink;  p: proc (self: ptr AppSink00; timeout: uint64; xdata: pointer): ptr gst.Sample00 {.cdecl.}, xdata: pointer, cf: gobject.ConnectFlags): culong =
  g_signal_connect_data(self.impl, "try-pull-preroll", cast[GCallback](p), xdata, nil, cf)

proc scTryPullSample*(self: AppSink;  p: proc (self: ptr AppSink00; timeout: uint64; xdata: pointer): ptr gst.Sample00 {.cdecl.}, xdata: pointer, cf: gobject.ConnectFlags): culong =
