...
proc scAnnouncement*(self: Object;  p: proc (self: ptr Object00; arg1: cstring; xdata: pointer) {.cdecl.}, xdata: pointer, cf: gobject.ConnectFlags): culong =
  g_signal_connect_data(self.impl, "announcement", cast[GCallback](p), xdata, nil, cf)

proc scAttributeChanged*(self: Object;  p: proc (self: ptr Object00; arg1: cstring; arg2: cstring; xdata: pointer) {.cdecl.}, xdata: pointer, cf: gobject.ConnectFlags): culong =
  g_signal_connect_data(self.impl, "attribute-changed", cast[GCallback](p), xdata, nil, cf)
...
proc scNotification*(self: Object;  p: proc (self: ptr Object00; arg1: cstring; arg2: int32; xdata: pointer) {.cdecl.}, xdata: pointer, cf: gobject.ConnectFlags): culong =
  g_signal_connect_data(self.impl, "notification", cast[GCallback](p), xdata, nil, cf)
...
proc atk_object_get_help_text(self: ptr Object00): cstring {.
    importc, libprag.}

proc getHelpText*(self: Object): string =
  result = $atk_object_get_help_text(cast[ptr Object00](self.impl))

proc helpText*(self: Object): string =
  result = $atk_object_get_help_text(cast[ptr Object00](self.impl))
...
proc atk_object_set_accessible_id(self: ptr Object00; id: cstring) {.
    importc, libprag.}

proc setAccessibleId*(self: Object; id: cstring) =
  atk_object_set_accessible_id(cast[ptr Object00](self.impl), id)

proc `accessibleId=`*(self: Object; id: cstring) =
  atk_object_set_accessible_id(cast[ptr Object00](self.impl), id)
...
proc atk_object_set_help_text(self: ptr Object00; helpText: cstring) {.
    importc, libprag.}

proc setHelpText*(self: Object; helpText: cstring) =
  atk_object_set_help_text(cast[ptr Object00](self.impl), helpText)

proc `helpText=`*(self: Object; helpText: cstring) =
  atk_object_set_help_text(cast[ptr Object00](self.impl), helpText)
...
proc doAction*(self: Action | Hyperlink | NoOpObject; i: int): bool =
...
proc getDescription*(self: Action | Hyperlink | NoOpObject; i: int): string =
...
proc getKeybinding*(self: Action | Hyperlink | NoOpObject; i: int): string =
...
proc getLocalizedName*(self: Action | Hyperlink | NoOpObject;
    i: int): string =
...
proc getNActions*(self: Action | Hyperlink | NoOpObject): int =
  int(atk_action_get_n_actions(cast[ptr Action00](self.impl)))

proc nActions*(self: Action | Hyperlink | NoOpObject): int =
  int(atk_action_get_n_actions(cast[ptr Action00](self.impl)))

proc atk_action_get_name(self: ptr Action00; i: int32): cstring {.
    importc, libprag.}

proc getName*(self: Action | Hyperlink | NoOpObject; i: int): string =
...
proc setDescription*(self: Action | Hyperlink | NoOpObject; i: int;
    desc: cstring): bool =
...
proc scBoundsChanged*(self: Component | Socket | NoOpObject | Plug;  p: proc (self: ptr Component00; arg1: Rectangle; xdata: pointer) {.cdecl.}, xdata: pointer, cf: gobject.ConnectFlags): culong =
...
proc getAlpha*(self: Component | Socket | NoOpObject | Plug): cdouble =
  atk_component_get_alpha(cast[ptr Component00](self.impl))

proc alpha*(self: Component | Socket | NoOpObject | Plug): cdouble =
  atk_component_get_alpha(cast[ptr Component00](self.impl))

proc atk_component_get_layer(self: ptr Component00): Layer {.
    importc, libprag.}

proc getLayer*(self: Component | Socket | NoOpObject | Plug): Layer =
  atk_component_get_layer(cast[ptr Component00](self.impl))

proc layer*(self: Component | Socket | NoOpObject | Plug): Layer =
  atk_component_get_layer(cast[ptr Component00](self.impl))

proc atk_component_get_mdi_zorder(self: ptr Component00): int32 {.
    importc, libprag.}

proc getMdiZorder*(self: Component | Socket | NoOpObject | Plug): int =
  int(atk_component_get_mdi_zorder(cast[ptr Component00](self.impl)))

proc mdiZorder*(self: Component | Socket | NoOpObject | Plug): int =
  int(atk_component_get_mdi_zorder(cast[ptr Component00](self.impl)))

proc atk_component_get_size(self: ptr Component00; width: var int32; height: var int32) {.
    importc, libprag.}

proc getSize*(self: Component | Socket | NoOpObject | Plug;
...
proc grabFocus*(self: Component | Socket | NoOpObject | Plug): bool =
...
proc removeFocusHandler*(self: Component | Socket | NoOpObject | Plug;
    handlerId: int) =
...
proc setSize*(self: Component | Socket | NoOpObject | Plug;
...
proc scrollTo*(self: Component | Socket | NoOpObject | Plug;
...
proc contains*(self: Component | Socket | NoOpObject | Plug;
...
proc getExtents*(self: Component | Socket | NoOpObject | Plug;
...
proc getPosition*(self: Component | Socket | NoOpObject | Plug;
...
proc refAccessibleAtPoint*(self: Component | Socket | NoOpObject | Plug;
...
proc scrollToPoint*(self: Component | Socket | NoOpObject | Plug;
...
proc setExtents*(self: Component | Socket | NoOpObject | Plug;
...
proc setPosition*(self: Component | Socket | NoOpObject | Plug;
    x: int; y: int; coordType: CoordType): bool =
...
proc scDocumentAttributeChanged*(self: Document | NoOpObject;  p: proc (self: ptr Document00; arg1: cstring; arg2: cstring; xdata: pointer) {.cdecl.}, xdata: pointer, cf: gobject.ConnectFlags): culong =
  g_signal_connect_data(self.impl, "document-attribute-changed", cast[GCallback](p), xdata, nil, cf)
...
proc atk_document_get_text_selections(self: ptr Document00): ptr GArray00 {.
    importc, libprag.}

proc getTextSelections*(self: Document | NoOpObject): ptr GArray00 =
  atk_document_get_text_selections(cast[ptr Document00](self.impl))

proc textSelections*(self: Document | NoOpObject): ptr GArray00 =
  atk_document_get_text_selections(cast[ptr Document00](self.impl))
...
proc atk_document_set_text_selections(self: ptr Document00; selections: ptr GArray00): gboolean {.
    importc, libprag.}

proc setTextSelections*(self: Document | NoOpObject; selections: ptr GArray00): bool =
  toBool(atk_document_set_text_selections(cast[ptr Document00](self.impl), selections))
...
type
  FocusHandler* = proc (obj: ptr Object00; focusIn: gboolean) {.cdecl.}
...
type
  Live* {.size: sizeof(cint), pure.} = enum
    none = 0
    polite = 1
    assertive = 2
...
type
  TextSelection00* {.pure.} = object
  TextSelection* = ref object
    impl*: ptr TextSelection00
    ignoreFinalizer*: bool
...
proc atk_focus_tracker_notify(obj: ptr Object00) {.
    importc, libprag.}

proc focusTrackerNotify*(obj: Object) =
  atk_focus_tracker_notify(cast[ptr Object00](obj.impl))
